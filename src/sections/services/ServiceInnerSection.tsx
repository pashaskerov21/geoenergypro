            ...
            <div className="container">
                <div className="article_row">
                    <div className="article_col">
                        <article className="article_text" dangerouslySetInnerHTML={{ __html: dataState.activeServiceTranslate.text ?? '' }} ></article>
                    </div>
                    <div className="article_col">
                        <div className="article_image">
                            {dataState.activeService.image ?
                                <Image src={baseURL + dataState.activeService.image} width={1000} height={1000} alt={`GeoEnergyPro - ${dataState.activeServiceTranslate.title}`} priority={true} /> :
                                <Image src='/bg/image-3.jpg' width={1000} height={1000} alt={`GeoEnergyPro - ${dataState.activeServiceTranslate.title}`} priority={true} />
                            }
                        </div>
                    </div>
                </div>
