...
import { ProjectsLayout } from '@/src/layout';
...
export async function generateMetadata({ params: { lang } }: { params: { lang: LocaleType } }): Promise<Metadata> {
    try {
        ...
        const menuMetaParams = await menu.getMetaParams(lang, '/projects');
...
const Projects = async ({ params: { lang } }: { params: { lang: LocaleType } }) => {
    try {
        const dictionary = await getTranslate(lang);
        return (
            <>
